...
async function createAdmin() {
  ...
  try {
    ...
    const db = client.db('campus_connect'); // Use the same database name as server
    console.log('Using database:', db.databaseName);

    const adminEmail = process.env.ADMIN_EMAIL || 'admin@campusconnect.com'; // Use admin email from env
