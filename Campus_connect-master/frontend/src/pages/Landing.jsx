    ...
    <AuroraBackground>
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#0A0A0F] via-[#101020] to-[#0A0A0F] relative overflow-hidden animated-gradient-bg">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#7F40FF]/5 rounded-full blur-3xl animate-morphing-blob animate-drift delay-[2000ms]"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-[#FF7F50]/3 rounded-full blur-2xl animate-wave-motion animate-color-shift delay-[4000ms]"></div>
        </div>
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          ...
          <div ref={textRef} className="mb-8">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-[#1e3a8a] to-[#7c3aed] bg-clip-text text-transparent">
          ...
          <div ref={loadingRef} className="mt-12">
            <div className="flex items-center justify-center space-x-2">
              <div className="w-3 h-3 bg-[#1e3a8a] rounded-full animate-pulse animate-color-shift"></div>
              <div className="w-3 h-3 bg-[#7c3aed] rounded-full animate-pulse animate-color-shift delay-200"></div>
              <div className="w-3 h-3 bg-[#f97316] rounded-full animate-pulse animate-color-shift delay-400"></div>
            </div>
