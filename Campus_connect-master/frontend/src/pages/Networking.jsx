      ...
      <section className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-textMuted text-sm">{user.department} - {user.semester}</p>
                        </div>
                      </div>
                      <button
          ...
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-3xl font-semibold text-textPrimary mb-8">Follow Requests</h2>
            {loading ? (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-textPrimary">{request.sender?.name}</h3>
                          <p className="text-textMuted">{request.sender?.department} - {request.sender?.semester}</p>
                          <p className="text-textMuted text-sm">Follow request</p>
                        </div>
                      </div>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-textMuted text-lg">No pending follow requests.</p>
              </div>
            )}
          </motion.div>
          {}
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-semibold text-textPrimary mb-8">Following</h2>
            {connections.length > 0 ? (
                ...
                {connections.map((connection, index) => (
                  ...
                  >
                    <div className="text-center mb-6">
                      ...
                      <h3 className="text-xl font-semibold text-textPrimary mb-1">{connection.user?.name}</h3>
                      <p className="text-textMuted text-sm mb-2">{connection.user?.department} - {connection.user?.semester}</p>
              ...
              <div className="text-center py-12">
                <UsersIcon className="w-16 h-16 text-textMuted mx-auto mb-4" />
                <p className="text-textMuted text-lg">Not following anyone yet. Start following fellow students!</p>
              </div>
            )}
          </motion.div>
        </div>
