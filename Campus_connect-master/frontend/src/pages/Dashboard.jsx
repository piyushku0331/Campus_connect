...
import { User, Users, Calendar, BookOpen, Bell, Settings, Search, UserPlus } from 'lucide-react';
    ...
    <AuroraBackground>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-4xl font-semibold text-textPrimary mb-4">Search Users</h2>
              <p className="text-textMuted max-w-2xl mx-auto">Find and connect with other students on campus</p>
            </div>
            <div className="max-w-2xl mx-auto mb-8">
              <div className="flex gap-4">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-lg bg-card-gradient border border-borderMedium text-textPrimary placeholder-textMuted focus:outline-none focus:ring-2 focus:ring-primary"
                ...
                <motion.button
                  ...
                  className="px-6 py-3 bg-primary hover:bg-primary/80 text-white rounded-lg font-medium transition-colors disabled:opacity-50 flex items-center gap-2"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {searchResults.map((user) => (
                  <motion.div
                    ...
                    className="bg-card-gradient border border-borderMedium rounded-2xl p-6 hover:shadow-card-hover transition-all duration-300"
                  >
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      />
                      <div>
                        <button onClick={() => handleViewDetails(user.id)} className="font-semibold text-textPrimary hover:text-primary transition-colors text-left">{user.name}</button>
                    ...
                    <div className="flex gap-2">
                      <motion.button
                        ...
                        className="flex-1 px-4 py-2 bg-secondary hover:bg-secondary/80 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
                      >
                      ...
                      <motion.button
                        ...
                        className="flex-1 px-4 py-2 bg-accent hover:bg-accent/80 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
                      >
