...
// Admin redirect component - redirects admin users to admin panel
const AdminRedirect = () => {
        ...
        <main id="main-content" className="relative z-10 pt-20">
          ...
          <Suspense fallback={<LoadingSpinner />}>
            <Routes>
              ...
              <Route path="/dashboard" element={<PageWithFooter protected><AdminRedirect /></PageWithFooter>} />
              <Route path="/profile" element={<PageWithFooter protected><AdminRedirect /></PageWithFooter>} />
              <Route path="/events" element={<PageWithFooter protected><AdminRedirect /></PageWithFooter>} />
              <Route path="/networking" element={<PageWithFooter protected><AdminRedirect /></PageWithFooter>} />
              <Route path="/resources" element={<PageWithFooter protected><AdminRedirect /></PageWithFooter>} />
              <Route path="/notifications" element={<PageWithFooter protected><AdminRedirect /></PageWithFooter>} />
              <Route path="/settings" element={<PageWithFooter protected><AdminRedirect /></PageWithFooter>} />
              ...
              <Route path="/lostfound" element={<PageWithFooter protected><AdminRedirect /></PageWithFooter>} />
              <Route path="/alumni" element={<PageWithFooter protected><AdminRedirect /></PageWithFooter>} />
