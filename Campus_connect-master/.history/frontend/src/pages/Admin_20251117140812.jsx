                ...
                >
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-sm text-textMuted">
                              by {event.organizer_id?.name || 'Unknown'}
                            </span>
                          </div>
                          <h3 className="font-semibold text-textPrimary mb-2">{event.title}</h3>
                          <p className="text-textMuted text-sm mb-2">{event.description}</p>
                  ...
                  {pendingEvents.length === 0 && (
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-xl font-semibold text-textPrimary mb-2">No pending events</h3>
                      <p className="text-textMuted">All events have been reviewed.</p>
                    </div>
                  )}
                </motion.div>
              )}
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <GlowCard>
                      <div className="text-center">
                        <UserCheck className="w-8 h-8 text-green-500 mx-auto mb-2" />
                        <div className="text-2xl font-bold text-textPrimary">{alumni.length}</div>
                        <p className="text-textMuted">Total Alumni</p>
                      </div>
                    </GlowCard>
                    <GlowCard>
                      <div className="text-center">
                        <Users className="w-8 h-8 text-blue-500 mx-auto mb-2" />
                        <div className="text-2xl font-bold text-textPrimary">{users.filter(u => u.role === 'user').length}</div>
                        <p className="text-textMuted">Available Users</p>
                      </div>
                    </GlowCard>
                  </div>

                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-textPrimary">Current Alumni</h3>
                    {alumni.map((alum) => (
                      <GlowCard key={alum._id}>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            <img
                            ...
                            />
                            <div>
                              <h4 className="font-semibold text-textPrimary">{alum.name}</h4>
                              <p className="text-textMuted">{alum.email}</p>
                              <p className="text-sm text-textMuted">{alum.department} - {alum.semester}</p>
                            </div>
                          </div>
                          <button
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-textPrimary">Add New Alumni</h3>
